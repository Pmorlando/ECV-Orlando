...
//compiled with g++ -O0 -g -I/usr/local/include/opencv4 sifttry.cpp -o sifttry -L/usr/local/lib `pkg-config --libs opencv4`
...
int main(int argc, char** argv)
{
    ...
    sift->detectAndCompute(graybook, noArray(), kpsBook, desBook);
    sift->detectAndCompute(grayscene, noArray(), kpsScene, desScene);
