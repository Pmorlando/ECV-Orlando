...
// compiled with g++ -O0 -g -I/usr/local/include/opencv4 peopledetect.cpp -o peopledetect -L/usr/local/lib `pkg-config --libs opencv4`
...
int main(int argc, char** argv)
{
    ...
    else
    {
        ...
        // trying to find the file i am feeding it
        cap.open(file, CAP_FFMPEG);
    }
    if (!cap.isOpened())
    {
